    ...
    <main className="min-h-screen bg-slate-50">
      <nav className="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-2">
          <Logo />
          <span className="text-slate-400 text-sm ml-1">/ Jobs</span>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-sm text-slate-500 hidden sm:block">Hi, {userName}</span>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {jobs.length === 0 ? (
          <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
            ...
            <p className="text-slate-400 text-sm mt-1">We&apos;ll reach out when we find the right match.</p>
          </div>
        ) : (
              ...
              <div key={job.id} className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <svg
                      className={`w-5 h-5 text-slate-400 shrink-0 mt-0.5 transition-transform ${expanded === job.id ? 'rotate-180' : ''}`}
                  ...
                  <div className="px-6 pb-6 border-t border-slate-100">
                    ...
                    {job.jd_url && (
                      <div className="mt-4">
                        <a
                          ...
                          className="inline-flex items-center gap-2 border border-indigo-300 text-indigo-700 bg-indigo-50 hover:bg-indigo-100 rounded-lg px-4 py-2 text-sm font-medium transition-colors"
                        >
                    ...
                    <div className="mt-5 flex flex-col gap-3">
                      ...
                      <p className="text-xs text-slate-400 text-center">
                        ...
                        <a href="mailto:support@matchwork.in" className="text-indigo-500 underline">support@matchwork.in</a>
                      </p>
                    </div>
                  </div>
                )}
